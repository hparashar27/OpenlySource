...
const Opportunities = () => {
    ...
    useEffect(() => {
        const fecthData = async () => {
            await axios
                .get('http://localhost:8000/api/opportunities/events')
                .then((res) => {
    ...
    return (
        <div
            className={` ${
                DarkTheme
                    ? 'Opportunities_LightTheme'
                    : 'Opportunities_DarkTheme'
            }`}
        >
            {/* opportunities heading  */}
            <div className="Opp_heading">
                All Upcoming open-source opportunities
            ...
            <div className="Opp_cards_list">
                ...
                {Events &&
                    ...
                    Events.map((Event, _id) => (
                        <div key={_id} className="Opp_card">
                            <div className="card_left ">
                                <img src={Event.logo} className="event_logo" />
                            </div>
                            <div className="card_right">
                                <span className="card_right_heading">
                                    {Event.eventName}
                                </span>
