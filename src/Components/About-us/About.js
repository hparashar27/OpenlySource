    ...
    <>
            ...
            <div className="Column1 ">
              <div className="TextWrapper">
                ...
                <div className="SubTitle">
                  ...
                  with contributors from around the world. It is committed
                  towards providing resources and support to you and helps to
            ...
            <div className="TextWrapper">
              <div className="SubTitle">
                <ul>
                  ...
                  <li>
                    Get aware about upcoming hackathons and internship
                  ...
                  <li>
                    Learn new skills and technologies through hands-on
                    experience and mentorship.
                  </li>
                  <li>
                    Contribute to meaningful projects and make a positive impact
      ...
      <div className="newContainer">
        ...
        <div className="bottom-c">
          <h1 className="Heading3">Join Us Here</h1>
