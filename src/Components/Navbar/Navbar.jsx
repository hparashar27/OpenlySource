  ...
  return (
    <>
      <div className="gradient_bg">
        ...
        {toggleMenu
          ? <RiCloseLine classname="menu_icon" color="#fff" size={27} onClick={() => setToggleMenu(false)} />
          : <RiMenu3Line classname="menu_icon" color="#fff" size={27} onClick={() => setToggleMenu(true)} />}
        {toggleMenu && (
